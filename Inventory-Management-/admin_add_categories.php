...
{ 
	...
	if(strlen((string)$_REQUEST["cname"])!=0)
	{
		$category_name = $_REQUEST["cname"];
		insertIntoDB("begin add_category('$category_name');end;");
		header("Location: admin_manage_categories.php");
	}
	else{
		header("Location: admin_add_categories.php");
	}
}
?>
<!DOCTYPE HTML>
...
<head>
	...
	<!-- Customized css file -->
	<link rel="stylesheet" type="text/css" href="styles/admin_add_categories.css" />
...
<body>
	...
	<div id="container">
		...
		<div class="content">
			<form action="admin_add_categories.php" method="POST">
				<div class="first_block">
					...
					<input type="submit" name="create_new_category" value="Add">
