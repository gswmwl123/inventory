...
{
	$id = $_GET["did"];
	deleteFromDB("delete from category where category_id = $id");
...
<head>
	...
	<!-- Customized css file -->
	<link rel="stylesheet" type="text/css" href="styles/admin_manage_categories.css" />
		...
		<div class="content">
			<div class="content_area">
				...
				<table id="myTable">
					...
					<?php 
						$result = getJSONFromDB("select * from category order by CATEGORY_ID asc");
						...
						for($i=0;$i<sizeof($result);$i++){
							...
							echo "<tr>
								<td>$id</td>
								<td>$name</td>
								<td><a href='admin_manage_categories.php?did=$id'>Delete</a></td>
							 </tr>";
						}
					?>
				</table>
