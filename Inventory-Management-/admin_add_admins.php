		...
		<div class="content">
			<form action= "admin_add.php" method="POST" >
				<div class="first_block">
					...
					<p>Email Address</p>
					<input type="email" placeholder="Mail Address" name="umail" required>
					<p>Phone</p>
					<input type="number" placeholder="Contact No." name="ucontact" required>
					<p>Status</p>
				...
				<div class="second_block">
					...
					<input type="submit" name="admin_add" value="Add">
